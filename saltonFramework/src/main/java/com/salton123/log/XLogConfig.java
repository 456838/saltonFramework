...
public class XLogConfig {
    ...
    public com.salton123.log.XLogConfig setDebugable(boolean debugable) {
        isDebugable = debugable;
        return this;
    }

    public com.salton123.log.XLogConfig setSavePath(String savePath) {
        this.savePath = savePath;
        return this;
    }

    public com.salton123.log.XLogConfig setWhetherToSaveLog(boolean whetherToSaveLog) {
        this.whetherToSaveLog = whetherToSaveLog;
        return this;
    }

    public com.salton123.log.XLogConfig setLogDeleteDelayDay(int logDeleteDelayDay) {
        this.logDeleteDelayDay = logDeleteDelayDay;
        return this;
    }

    public com.salton123.log.XLogConfig setLogDefaultSplitSize(int logDefaultSplitSize) {

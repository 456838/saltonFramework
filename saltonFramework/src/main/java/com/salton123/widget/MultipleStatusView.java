...
public class MultipleStatusView extends FrameLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.salton_MultipleStatusView, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.salton_MultipleStatusView_salton_emptyView, R.layout.salton_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.salton_MultipleStatusView_salton_errorView, R.layout.salton_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.salton_MultipleStatusView_salton_loadingView, R.layout.salton_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.salton_MultipleStatusView_salton_noNetworkView, R.layout.salton_no_network_view);
        mContentViewResId = a.getResourceId(R.styleable.salton_MultipleStatusView_salton_contentView, NULL_RESOURCE_ID);
        a.recycle();

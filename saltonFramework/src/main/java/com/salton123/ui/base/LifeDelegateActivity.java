 ...
 * Description:
 */
public abstract class LifeDelegateActivity extends SupportActivity implements IComponentLife, ISwipeBackActivity {
    public LifeDelegate mLifeDelegate = new LifeDelegate(this);

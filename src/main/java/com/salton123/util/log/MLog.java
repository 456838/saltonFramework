package com.salton123.util.log;
...
import static com.salton123.util.log.LogToES.getThreadCalendar;
...
public class MLog {
    ...
    private static String createLogFileName() {
        ...
        Calendar c = getThreadCalendar();//减少创建对象
    ...
    private static boolean externalStorageExist() {
        ...
        return Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED ? true : false;
    }

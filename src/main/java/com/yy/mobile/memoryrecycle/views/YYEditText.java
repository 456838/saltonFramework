...
public class YYEditText extends EditText implements IRecycleView {
    ...
    public YYEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        DrawableRecycler.onAttributesUpdated(context, this, attrs);
    }

    public YYEditText(Context context, AttributeSet attrs, int defStyle) {
